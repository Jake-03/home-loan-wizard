...
module.exports = {
    ...
    'Test good Data': (browser) => {
        ...
        browser.expect.element(selectors.overviewScreenOutput.realEstateAgent).text.to.equal('Yes')
        browser.expect.element(selectors.overviewScreenOutput.purchasePrice).text.to.equal('1000000')
        browser.expect.element(selectors.overviewScreenOutput.downPayment).text.to.equal('100000')
    ...
    'Test bad Data "send"': (browser) => {
        ...
        // expects button to be disabled after entering bad data 
        browser.expect.element(selectors.priceDownPaymentScreen.wSixButton).to.have.attribute('disabled')
        functions.input(selectors.priceDownPaymentScreen.purchasePrice, data.goodData.priceDownPaymentScreen.inputEstimatedPrice, browser)
        functions.input(selectors.priceDownPaymentScreen.downPayment, data.goodData.priceDownPaymentScreen.inputDownPayment, browser)
        // expects button to be enabled after entering correct data
        // this guarantees that the following click only fails due to a time out and not a disabled button
        browser.expect.element(selectors.priceDownPaymentScreen.wSixButton).not.to.have.attribute('disabled')
        browser.click(selectors.priceDownPaymentScreen.wSixButton)
        ...
        browser.expect.element(selectors.nameScreen.marginButton).to.have.attribute('disabled')
        functions.input(selectors.nameScreen.email, data.goodData.nameScreen.inputEmailLineThree, browser)
        browser.expect.element(selectors.nameScreen.marginButton).not.to.have.attribute('disabled')

        browser
            .click(selectors.nameScreen.marginButton)
            // Overview
            .waitForElementVisible(selectors.overviewScreen.overviewText, 1000)
        ...
        browser.expect.element(selectors.overviewScreenOutput.city).text.to.equal('12345*$%$')
        ...
        browser.expect.element(selectors.overviewScreenOutput.realEstateAgent).text.to.equal('No')
        browser.expect.element(selectors.overviewScreenOutput.purchasePrice).text.to.equal('1000000')
        browser.expect.element(selectors.overviewScreenOutput.downPayment).text.to.equal('100000')
        browser.expect.element(selectors.overviewScreenOutput.creditScore).text.to.equal('Fair')
        browser.expect.element(selectors.overviewScreenOutput.bankruptcyHistory).text.to.equal('Has had a foreclosure before')
