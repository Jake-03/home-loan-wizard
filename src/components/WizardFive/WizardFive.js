        ...
        return(
            <div className="parent-div">
                <div className="vert-align">
                    ...
                    <div className="row">
                        <Link to="/wSix"><button name="yesAgent" onClick={ (e)=>this.props.updateRealEstateAgent("Yes") }>Yes</button></Link>
                        <Link to="/wSix"><button name="noAgent" onClick={ (e)=>this.props.updateRealEstateAgent("No") }>No </button></Link>
                    </div>
                </div>
            </div>
        )
